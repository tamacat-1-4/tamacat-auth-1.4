...
/**
 * Generating and verify Time based One-Time Password. (OTP/TOTP)
 * https://tools.ietf.org/html/rfc6238
 * 
 * Copy from aerogear-otp-java
...
public class Totp {
     ...
     *
     * @param secret Shared secret
     * @param interval  Clock responsible for retrieve the current interval
     */
    public Totp(String secret, int interval) {
        this.secret = secret;
